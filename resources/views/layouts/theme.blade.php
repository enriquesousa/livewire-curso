            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="la la-rocket"></i><span class="menu-title" data-i18n="Authentication">Starting</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="login-with-bg-image.html" target="_blank"><i></i><span>Instalación</span></a>
                        </li>
                        <li><a class="menu-item" href="login-with-bg-image.html" target="_blank"><i></i><span>Assets</span></a>
                        </li>
                        <li><a class="menu-item" href="register-with-bg-image.html" target="_blank"><i></i><span>Configuración</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class=" nav-item"><a href="#"><i class="ft-grid"></i><span class="menu-title" data-i18n="Authentication">Componentes</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="login-with-bg-image.html" target="_blank"><i></i><span>Inline</span></a>
                        </li>
                        <li><a class="menu-item" href="{{ route('full-page') }}" target="_blank"><i></i><span>Full Page</span></a>
                        </li>
                        <li><a class="menu-item" href="register-with-bg-image.html" target="_blank"><i></i><span>Anidados</span></a>
                        </li>
                        <li><a class="menu-item" href="register-with-bg-image.html" target="_blank"><i></i><span>Pasar Parámetros</span></a>
                        </li>
                        <li><a class="menu-item" href="register-with-bg-image.html" target="_blank"><i></i><span>Propiedades</span></a>
                        </li>
                        <li><a class="menu-item" href="register-with-bg-image.html" target="_blank"><i></i><span>Databinding</span></a>
                        </li>
                        <li><a class="menu-item" href="register-with-bg-image.html" target="_blank"><i></i><span>Actions</span></a>
                        </li>
                        <li><a class="menu-item" href="register-with-bg-image.html" target="_blank"><i></i><span>Lifecycle</span></a>
                        </li>
                    </ul>
                </li>
                </li>
                ...
                <li class=" nav-item"><a href="#"><i class="la la-list"></i><span class="menu-title" data-i18n="Authentication">Formularios</span></a>
                    <ul class="menu-content">
                        <li class=" nav-item"><a href="crypto-history.html"><span class="menu-title" data-i18n="History">Archivos</span></a>
                        </li>
                        <li class=" nav-item"><a href="crypto-history.html"><span class="menu-title" data-i18n="History">Validaciones</span></a>
                        </li>
                ...
                <li class=" nav-item"><a href="#"><i class="la la-comment"></i><span class="menu-title" data-i18n="Authentication">Comunicacion</span></a>
                    <ul class="menu-content">
                        <li class=" nav-item"><a href="crypto-history.html"><span class="menu-title" data-i18n="History">Back Events</span></a>
                        </li>
                        <li class=" nav-item"><a href="crypto-history.html"><span class="menu-title" data-i18n="History">Front Events</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="ft-underline"></i><span class="menu-title" data-i18n="Authentication">UI Nice</span></a>
                    <ul class="menu-content">
                        <li class=" nav-item"><a href="crypto-wallet.html"><span class="menu-title" data-i18n="Wallet">Traits</span></a>
                        </li>
                        <li class=" nav-item"><a href="crypto-history.html"></i><span class="menu-title" data-i18n="History">Loading States</span></a>
                        </li>
                        <li class=" nav-item"><a href="crypto-history.html"></i><span class="menu-title" data-i18n="History">Polling</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="ft-check-square"></i><span class="menu-title" data-i18n="Authentication">Testing</span></a>
                    <ul class="menu-content">
                        <li class=" nav-item"><a href="crypto-history.html"></i><span class="menu-title" data-i18n="History">Example</span></a>
                        </li>
                    </ul>
                </li>
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                {{-- Esto es mas moderno si usamos return view('livewire.full-page')->layout('layouts.theme'); --}}
                {{ $slot }}

                {{-- Esto es si vamos a usar return view('livewire.full-page')->extends('layouts.theme')->section('content'); --}}
                {{-- @yield('content') --}}
